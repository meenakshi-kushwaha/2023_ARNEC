...
ggplot(aes(x = long, y = lat, group = group, fill = val)) +
  geom_polygon() +
  scale_fill_continuous(type = "gradient", guide = "colourbar",
                        low = "#fee0d2", high = "#9c1c1e") +
  coord_fixed(xlim = c(60, 170)) +
...
ggsave(width = 10, height = 10, path = here("plots"), filename = "map1.jpg")
...
map3 <- asia_pac_mort %>% 
  ggplot(aes(x = long, y = lat, group = group, fill = val)) +
  geom_polygon() +
  scale_fill_binned(type = "gradient", guide = "colourbar",
                    low = "#fee0d2", high = "#9c1c1e") +
  coord_fixed(xlim = c(60, 170)) +
...
ggsave(width = 10, height = 10, path = here("plots"), filename = "map3.jpg")
...
map_2
ggsave(width = 10, height = 10, path = here("plots"), filename = "map3.jpg")
test <- map_data("world", region = "China")
